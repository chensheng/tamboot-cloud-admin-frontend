...
const proxy = {
  'GET /api/system-app/system/menu/tree': (req, res) => {
    res.json({
  ...
  'GET /api/system-app/system/menu/roleMenus': (req, res) => {
    res.json({
      code: BusinessCode.SUCCESS,
      msg: 'success',
      data: [
  ...
  'POST /api/system-app/system/menu/update': (req, res) => {
    res.json({
      code: BusinessCode.SUCCESS,
      msg: 'success',
    });
  ...
  'POST /api/system-app/system/menu/create': (req, res) => {
    res.json({
      code: BusinessCode.SUCCESS,
      msg: 'success',
    });
  ...
  'POST /api/system-app/system/menu/delete/:id': (req, res) => {
    res.json({
      code: BusinessCode.SUCCESS,
      msg: 'success',
    });
